...
<div class="pro-task" markdown="1" id="navigating-as-pro-staff">

### Navigating FixMyStreet Pro as a staff user

<img alt="When you're loggedin as an administrator the 'admin' button is in the navigation menu" src="/assets/img/pro-user-guide/navigating-as-pro-staff.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="viewing-reports-your-area">

### Viewing all reports in your area

<span class="pro-task__permissions">Permissions required: none</span>
...
<img alt="Click all reports in the top menu to view all reports in an area" src="/assets/img/pro-user-guide/viewing-reports-your-area.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="defining-area-interest">
...
<div class="pro-task" markdown="1" id="view-report-specific-area">
...
<div class="pro-task" markdown="1" id="filtering-sorting-reports">

### Filtering and sorting reports

<span class="pro-task__permissions">Permissions required: none</span>

<img alt="The drop-downs at the top of the report list allow you to filter which reports you see" src="/assets/img/pro-user-guide/filtering-sorting-reports.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="view-single-report">
...
<div class="pro-task" markdown="1" id="search-report">

### Searching for a report

<span class="pro-task__permissions">Permissions required: User must be marked as staff</span>
...
<img alt="There are a number of different options for using the Search Reports box" src="/assets/img/pro-user-guide/search-report.png" class="pro-screenshot" />

The search will return a list of all reports that fulfil your parameters. Click on the report’s ID
number to see it in a new browser window; or click on the word ‘Edit’ to gain access the tools that
(depending on the staff user’s permissions) allow editing of reports, prioritisation, changing a
report’s status, etc.

</div>

<div class="pro-task" markdown="1" id="search-user">
...
<div class="pro-task" markdown="1" id="editing-users-information">

### Editing a user’s information

<span class="pro-task__permissions">Permissions required: User must be marked as staff; "Edit users' details/search for their reports" must be ticked.</span>
...
<div class="pro-task" markdown="1" id="view-reports-non-staff-user">
...
<div class="pro-task" markdown="1" id="create-reports-behalf-user">

### Creating reports on behalf of another user

<span class="pro-task__permissions">Permissions required: User must be marked as staff; ‘Create reports/updates on a user's behalf’ must be ticked. ‘Create reports/updates as anonymous user’ and ‘Create reports/updates as the council’ are also options.</span>
...
citizen’s experience](/pro/citizens-experience/)'. Those with the appropriate permissions will see a dropdown box in
...
<div class="pro-task" markdown="1" id="deal-undesirable-content">
...
<span class="pro-task__permissions">Permissions required: User must be marked as staff; ‘moderate report details’ must be ticked.</span>
...
<img alt="The ‘moderate’ button below the report’s main body" src="/assets/img/pro-user-guide/deal-undesirable-content.png" class="pro-screenshot" />
...
<span class="pro-task__permissions">Permissions required:​ ​User must be marked as staff, ‘Edit reports’ must be ticked.</span>
...
<img alt="Ban a user directly from a report page" src="/assets/img/pro-user-guide/ban-user-report-page.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="correct-reporter-errors">

### Correcting reporter errors

#### Changing a report’s category

<span class="pro-task__permissions">Permissions required: User must be marked as staff, and ‘edit report category’ must be ticked.</span>

If the user has chosen the wrong category for their report, when logged in, staff with the appropriate permissions can change it from the dropdown to the right of the report.

<img alt="Change the category of a report" src="/assets/img/pro-user-guide/change-category-report.png" class="pro-screenshot" />
...
the report unless the send method has changed (e.g. in the case of councils where some reportsare sent via the Open311 protocol and others by email).

#### Changing the location
Permissions required: User must be marked as staff, and ‘Edit report priority’ must be ticked.
...
‘set to my current location’. This will reset the co-ordinates of the issue to reflect a more

</div>

<div class="pro-task" markdown="1" id="keep-report-maker-informed">
...
<img alt="Use a template to make public updates faster" src="/assets/img/pro-user-guide/report-public-update.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="prioritising-tasks">

### Prioritising tasks

<span class="pro-task__permissions">Permissions required: User must be marked as staff and ‘edit report priority’ or 'mark up problem
details' must be ticked.</span>

<img alt="Set a report priority from the report screen" src="/assets/img/pro-user-guide/report-change-priority.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="working-with-shortlists">

### Working with shortlists

<span class="pro-task__permissions">Permissions required: User must be marked as staff and ‘manage shortlist’ must be ticked.</span>
...
<img alt="Add reports to your shortlist by clicking the star icons" src="/assets/img/pro-user-guide/all-reports-shortlist.png" class="pro-screenshot" />
...
<img alt="Add a report to your shortlist from within the individual report page" src="/assets/img/pro-user-guide/report-page-shortlist.png" class="pro-screenshot" />
...
<img alt="View your shortlist from the link in the navigation bar" src="/assets/img/pro-user-guide/your-shortlist.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="viewing-editing-reports">
...
Your edits will automatically synchronise once you’re back online: just visit FixMyStreet while
logged in as a staff member.

</div>

<div class="pro-task" markdown="1" id="adminstrating-staff-accounts">

### Administrating staff accounts

#### Creating a staff account

<span class="pro-task__permissions">Permissions required: User must be marked as staff; ‘Edit other users’ permissions’ must be ticked.</span>

<img alt="From the user admin page you can administer staff accounts" src="/assets/img/pro-user-guide/user-admin-page.png" class="pro-screenshot" />
...
<img alt="You can assign permissions to users on this screen" src="/assets/img/pro-user-guide/user-admin-permissions.png" class="pro-screenshot" />
...
<span class="pro-task__permissions">Permissions required: User must be marked as staff; ‘Edit other users' permissions’ and ‘Assign users to areas in Council’ must be ticked.</span>

<img alt="You can allocate categories to individual users by checking the relevant category boxes" src="/assets/img/pro-user-guide/user-admin-categories.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="creating-editing-categories">
...
<span class="pro-task__permissions">Permissions required: User must be marked as staff; “Add/edit problem categories” must be
ticked.</span>

<img alt="Control the categories the site displays when a report is made here" src="/assets/img/pro-user-guide/category-admin-page.png" class="pro-screenshot" />
...
<img alt="You can edit categories using the edit category interface" src="/assets/img/pro-user-guide/edit-category-page.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="creating-editing-priorities">

### Creating and editing priorities

<span class="pro-task__permissions">Permissions required: User must be marked as staff; “Add/edit response priorities” must be ticked.</span>
...
<img alt="Set your priorities to reflect your organisations needs" src="/assets/img/pro-user-guide/response-priority-screen.png" class="pro-screenshot" />
...
<div class="pro-task" markdown="1" id="creating-editing-response-templates">

### Creating and editing response templates

<span class="pro-task__permissions">Permissions required: User must be marked as staff; “Add/edit response templates” must be ticked.</span>

<img alt="You can create and edit pre-written responses on the response templates screen" src="/assets/img/pro-user-guide/response-template-screen.png" class="pro-screenshot"/>
...
<div class="pro-task" markdown="1" id="view-statistics">
