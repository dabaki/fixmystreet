...
OpenLayers.Layer.VectorNearest = OpenLayers.Class(OpenLayers.Layer.Vector, {
    ...
    initialize: function(name, options) {
        ...
        $(fixmystreet).on('report_new:category_change:extras_received', this.updateUSRNField.bind(this));
    ...
    road_not_found: function() {
        if (this.fixmystreet.actions) {
            ...
            if ( this.fixmystreet.actions.unselected ) {
                this.fixmystreet.actions.unselected();
            }
